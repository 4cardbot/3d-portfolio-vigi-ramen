...
export default class RayCaster
{
    constructor()
    {
        ...
        this.preLoader.on('start', () =>
        {
            ...
            this.vGHitBox = new THREE.Mesh(
                new THREE.BoxGeometry( 0.4, 1, 1 ),
                this.hitBoxMaterial
            )
            this.vGHitBox.position.set(-4,-0.4,-4.72)
            ...
            this.signHitBoxes.add(this.projectsHitBox, this.vGHitBox, this.articlesHitBox,this.aboutMeHitBox, this.creditsHitBox )
            ...
            if(this.debug.active)
            {
                ...
                this.debugFolder
                    ...
                    .onChange(() =>
                    {
                        ...
                        this.vGHitBox.visible = this.hitBoxVisibility.visible
            ...
            this.objectsToTest = [
                ...
                this.ramenShop.vGBlack, this.ramenShop.vGPink,
    ...
    click(cursor)
    {
        ...
        if(this.intersectsObjects.length)
        {
            ...
            switch(this.selectedModel)
            {
                ...
                case this.ramenShop.vGBlack:
                case this.ramenShop.vGPink:
                case this.vGHitBox:
                    this.controller.menuControls.vG(this.ramenShop.vGBlack, 'black')
                    break
