...
export default class Controller
{
    ...
    setMenuControls()
    {
        ...
        this.menuControls.vG = async (obj, color) =>
        {
            if(this.logic.buttonsLocked === false && this.logic.mode === 'menu')
            {
                this.sounds.playClick()
                ...
                this.menuControls.buttonIndicator(obj, color)
                this.camera.transitions.vG(1.5)
            }
        }
    ...
    setVideoControls()
    {
        ...
        this.videoControls.tvScreen = async () =>
        {
            ...
            {this.resources.video['tvScreenVideoTexture'].play()}
                ...
                window.open('https://youtu.be/fNqtZcy3aag', '_blank');
        ...
        this.smallScreen3Counter = 1

        this.videoControls.smallScreen3 = async () =>
        {
            if(this.smallScreen3Counter < this.resources.carousel3.length)
            {this.smallScreen3Counter++}
            else {this.smallScreen3Counter = 1}

            this.screenTransition(
                this.materials.smallScreen3Material,
                this.resources.carousel3[this.smallScreen3Counter-1],
                0.8
            )
    ...
    setSocialControls()
    {
        ...
        this.socialControls.gitHub = async () =>
        {
            if(this.logic.buttonsLocked === false && (this.logic.mode === 'aboutMe' || this.logic.mode === 'skills' || this.logic.mode === 'experience'))
            {
                window.open('https://github.com/4cardbot', '_blank');
            }
        ...
        this.socialControls.mail = async () =>
        {
            if(this.logic.buttonsLocked === false && (this.logic.mode === 'aboutMe' || this.logic.mode === 'skills' || this.logic.mode === 'experience'))
            {
                window.location.href='mailto:vaibhav050196@gmail.com'
            }
