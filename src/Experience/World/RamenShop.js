...
export default class RamenShop
{
    ...
    parseModel()
    {
        ...
        this.VGJoined = this.model.children.find(child => child.name === 'VGJoined')
        ...
        this.vGBlack = this.model.children.find(child => child.name === 'jZhouBlack')
        this.vGPink = this.model.children.find(child => child.name === 'jZhouPink')
    ...
    setMaterials()
    {
        ...
        this.resources.on('texturesMapped', () =>
        {
            ...
            this.VGJoined.material = this.materials.whiteSignMaterial
            ...
            this.vGBlack.material = this.materials.blackSignMaterial
            this.vGPink.material = this.materials.pinkSignMaterial
            ...
            this.smallScreen3.material = this.materials.smallScreen3Material
